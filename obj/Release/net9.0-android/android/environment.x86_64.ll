...
@aot_dso_cache = dso_local local_unnamed_addr global [765 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 u0x0f77bdbe937c95e2, ; from name: aot-Quiz Point Counter.dll.so
		i64 u0x8359a41b0f4d1d3a, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-Quiz Point Counter.dll.so
		ptr null; void* handle
	}, ; 58
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 u0x234ad4701180a341, ; from name: Quiz Point Counter.so
		i64 u0x8359a41b0f4d1d3a, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-Quiz Point Counter.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0x248d7319abdcd2fa, ; from name: Quiz Point Counter
		i64 u0x8359a41b0f4d1d3a, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-Quiz Point Counter.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0x796b3a5794027644, ; from name: aot-Quiz Point Counter
		i64 u0x8359a41b0f4d1d3a, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-Quiz Point Counter.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0x8359a41b0f4d1d3a, ; from name: libaot-Quiz Point Counter.dll.so
		i64 u0x8359a41b0f4d1d3a, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-Quiz Point Counter.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0x98cddac3f8b893e0, ; from name: libaot-Quiz Point Counter.so
		i64 u0x8359a41b0f4d1d3a, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-Quiz Point Counter.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0xd058ba8c15e3aaed, ; from name: aot-Quiz Point Counter.so
		i64 u0x8359a41b0f4d1d3a, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-Quiz Point Counter.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0xe2b41fe9a5e0a618, ; from name: libaot-Quiz Point Counter
		i64 u0x8359a41b0f4d1d3a, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-Quiz Point Counter.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0xe408be6d58c5c9ba, ; from name: Quiz Point Counter.dll.so
		i64 u0x8359a41b0f4d1d3a, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-Quiz Point Counter.dll.so
		ptr null; void* handle
...
;ApplicationConfig
@.ApplicationConfig.0_android_package_name = private unnamed_addr constant [33 x i8] c"com.companyname.quizpointcounter\00", align 16
...
@.DSOCacheEntry.8_name = private unnamed_addr constant [33 x i8] c"libaot-Quiz Point Counter.dll.so\00", align 16
